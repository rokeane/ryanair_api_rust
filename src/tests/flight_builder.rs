...
pub fn nominal_case() {
    ...
    assert_eq!(
        lib::get_weekday_combinations("2024-04-15", "2024-05-15", "monday", "sunday",),
        expected
    );
}
...
pub fn narrow_date_range_case() {
    let expected: Vec<(String, String)> = vec![];
    assert_eq!(
        lib::get_weekday_combinations("2024-04-15", "2024-04-20", "monday", "sunday",),
        expected
    );
}
...
pub fn end_date_always_after_start_state_case() {
    ...
    assert_eq!(
        lib::get_weekday_combinations("2024-04-13", "2024-05-13", "monday", "sunday",),
        expected
    );
}
